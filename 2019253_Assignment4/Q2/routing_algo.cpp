...
void routingAlgo(vector<RoutingNode *> nd)
{
  ...
  cout << "\nRouting table after changing routing table entries for node B and C as given in question and removing link between B and C:\n\n";
  ...
  while (1)
  {
    ...
    /*check if the routing tables have converged. they wont converge in this case*/
    for (int i = 0; i < nd.size(); i++)
    {
      if (nd[i]->getTable().tbl.size() != prev[i].tbl.size())
      {
